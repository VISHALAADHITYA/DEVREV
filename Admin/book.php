...
<body style="background-image:url(images/bookback.jpg)">
	...
	<div class="sucontainer" style="background-image:url(images/bookback.jpg)">
		...
		<select id="centers-list" name="Centers" onChange="getvaccineday(this.value);" style="width:100%;height:35px;border-radius:9px">
		<option value="">Select Centers</option>
		</select><br>
		
		<label style="font-size:20px" >vaccine:</label><br>
		<select id="vaccine-list" name="vaccine" onChange="getDate(this.value);" style="width:100%;height:35px;border-radius:9px">
