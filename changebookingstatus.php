...
<body style="background-color:white">
	...
	<div class="sucontainer">
		...
		<select name="vaccine" id="doctor-list" class="demoInputBox" style="width:100%;height:35px;border-radius:9px">
		...
		?>
		<option value="<?php echo $rs["DID"]; ?>"><?php echo "Vaccine. ".$rs["Name"]; ?></option>
		<?php
		}
		?>
		</select>
