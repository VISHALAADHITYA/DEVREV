...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="cal.png" width="30px" height="30px"><strong> COVACC </strong>Covid Vaccination Booking</a></li>
			...
			<div class="center">
				<h1>COVACC</h1><br>
				<p style="text-align:center;color:black;font-size:30px;top:35%">Covid Vaccination Booking</p><br>
